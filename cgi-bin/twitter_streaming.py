         ...
         if 'text' in data:
            ...
            ##-------utc created date------
             ...
             try:
                 ...
                 cur.execute('''INSERT INTO social_media.tweet(tweets,geom,tweet_long,tweet_lat,status_json,date,date_utc,tweet_location,hashtags,screen_name,user_id,media_url) VALUES (%s,ST_GeomFromText(%s,4326),%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)''', (tweet_text,coordinates,longitude,latitude,data_json,date,created_at,tweet_location,hashtag_list,screen_name,user_id,media_list))
             except:
                 longitude = None
                 latitude = None
                 coordinates = None
...
stream = MyStreamer("wOZVLoFlFIJyRXL8kSO3JqYqe",
					"5mZTEQzgSnPrhWjqNLQNfADV9dMnhEQtp9kqB4hjd9kK3QAhpT",
					"2903312516-aqImwAzJ7h9X9tUHNgzIGv6AvEBow8eJWxi2iYl",
					"SVPnZXns7638XSjeLaAibwg27tRC3ldIEdD3Qh0tPbBNq"
)
