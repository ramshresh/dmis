...
use common\modules\reporting\models\Need as NeedModel;
...
/**
 * Need represents the model behind the search form about `common\modules\reporting\models\Need`.
 */
class Need extends NeedModel
{
    //{{{ initialization
    public function init()
    {
         ...
         *  Models 'DamageSearch' --extends--> 'DamageModel' --extends--> 'ReportItemModel'
         */
    ...
    {
        return [
            [['id', 'reportitem_id', 'quantity', 'status'], 'integer'],
            [['units_shortname', 'units_displayname'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'units_shortname', $this->units_shortname])
            ->andFilterWhere(['like', 'units_displayname', $this->units_displayname]);
