...
class PointPickerOl3BootstrapModalWidget extends Widget{
    ...
    public function init()
    {
            ...
            */
			PointPickerOl3BootstrapModalAsset::register($this->getView());
    }
    ...
    public function run()
    {
        ...
        $this->getView()->registerJs("$('#{$this->id}').pointPicker({$options});",View::POS_READY);

        $this->htmlOptions['id'] = $this->id;
        $this->htmlOptions['class'] = 'pointpicker';


        return $this->render('point-picker-ol3-bootstrap-modal-widget',array('opts'=>$opts));
    }
}
