...
use common\modules\social_media\models\searchTweetSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CrudTweetController implements the CRUD actions for Tweet model.
 */
class CrudTweetController extends Controller
{
    ...
    {
        $searchModel = new searchTweetSearch();
