...
$dropDownItemNameEvent = $model::getDropDownItemName((new ReportItemEvent())->type);
?>

<div id="<?=$widgetId?>" class="hidden" title="Add new Incident">
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            echo $form->field($model, 'item_name')
                ->widget(\kartik\widgets\Select2::classname(), [
                    ...
                    'options' => ['placeholder' => '--Select Incident Name--'],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
        ...
        <?php
        echo _Create::widget(['modelClass'=>ReportItemNeed::className(),'allModels'=>$model->needs]);
        ?>
        <div class="row">
