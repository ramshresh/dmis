...
class ReportItemNeed extends ReportItem{
    ...
    public function getImpact() {
        return $this->hasOne(ReportItemImpact::className(), ['id' => 'parent_id','type'=>'parent_type'])
