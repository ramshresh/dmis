...
/**
 * ReportItemIncidentSearch represents the model behind the search form about `common\modules\rapid_assessment\models\ReportItemIncident`.
 */
class ReportItemIncidentSearch extends ReportItemIncident
{
    /**
     * @inheritdoc
     */
