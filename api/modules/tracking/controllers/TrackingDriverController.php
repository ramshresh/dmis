...
use common\modules\tracking\models\sql_views\TrackingDriver;
use yii\data\ActiveDataProvider;
use yii\db\Query;

class TrackingDriverController extends \yii\rest\ActiveController
{
    public $modelClass = 'common\modules\tracking\models\sql_views\TrackingDriver';
