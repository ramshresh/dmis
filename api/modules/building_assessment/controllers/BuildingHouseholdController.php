...
namespace api\modules\building_assessment\controllers;
...
class BuildingHouseholdController extends ActiveController
{
    public $modelClass = 'common\modules\building_assessment\models\BuildingHousehold';
    ...
    public function actions()
    {
        return ArrayHelper::merge(
            ...
            [
                'create'=>[
                    'class'=>'common\modules\building_assessment\actions\rest\BuildingHouseholdCreateAction',
    ...
    public function actionUnique()
    {
        ...
        $query->andWhere(['not', [$property => null]]);
