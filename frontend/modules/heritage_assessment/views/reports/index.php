        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <div id="mapDetailBody" class="box-body" style="height: 22em">
...
<script>
    ...
    var geojson,
        metadata = {
            "attribution": "Heritage Survey of Kathmandu Valley(2015), KMC",
    ...
    //Add basemap
    L.tileLayer(tileServer, {attribution: tileAttribution, maxZoom: 22}).addTo(map);
...
<script id="template" type="x-tmpl-mustache">
                ...
                <div id="afterPhotos" class="box-body" style="height:auto;white-space: nowrap;overflow-x: auto" >
                  {{#items}}
                      <img class="grid-item" src="{{src}}" alt="{{alt}}" style="width:240;height:200px;">
                  {{/items}}
                 </div>
