        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <div id="mapPhotosBody" class="box-body">
                        loading...
                    </div>
                    <!-- /.box-body -->
                </div>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    {{#indicators}}
                      <li data-target="{{data-target}}" data-slide-to="{{data-slide-to}}" class="{{class}}"></li>
                     {{/indicators}}
                    </ol>
                    <div class="carousel-inner">
                    {{#items}}
                      <div class="{{class}}">
                        <img class="img-carousel" src="{{src}}" alt="{{alt}}">
